...
<title>@yield('title', 'Helpdesk') - {{ config('app.name', 'Helpdesk') }}</title>
...
<body class="font-sans bg-white min-h-screen overflow-x-hidden text-foreground" x-data="{ sidebarOpen: false }">
