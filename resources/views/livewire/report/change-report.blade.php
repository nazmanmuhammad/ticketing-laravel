@section('title', 'Change Request Report')
@section('page-title', 'Change Request Report')
@section('page-description', 'Change request analytics')
...
<div>
    ...
    <div class="bg-white rounded-2xl border border-border p-5 mb-6">
        <p class="text-lg font-bold text-foreground">{{ number_format($total) }} <span class="text-sm font-medium text-secondary">total change requests</span></p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-border p-6">
            <h3 class="font-semibold text-foreground mb-4">By Type</h3>
